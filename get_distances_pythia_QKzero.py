...
### Decide which layer/head combination you will modify
## TODO: ideally, determine this programatically from the results of the 
## experimental stimulus manipulation
layer_idx = 2
head_idx = 1
...
def main(df, mpath, revisions, modification, layer_idx, head_idx):
    ...
    for checkpoint in tqdm(revisions):
        ...
        savepath = f"../../data/processed/rawc/pythia-QKmod-zero/distances_ablate_layer{layer_idx}head{head_idx}/"
